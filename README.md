...
[llvm-stackmap-parser](https://crates.io/crates/llvm-stackmap-parser) to parse
the Stack Map records emitted by LLVM. See [this
section](#generational-garbage-collection) for more information on the garbage
collection runtime.
